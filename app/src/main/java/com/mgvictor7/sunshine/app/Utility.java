...
public class Utility {
    ...
    private static String languageDevice = Locale.getDefault().getLanguage();

    private static String getSymbol(boolean isMetric) {
        if (isMetric) {
            return "ºC";
        }
        return "ºF";
    ...
    public static boolean isMetric(Context context) {
        ...
        return prefs.getString(context.getString(R.string.pref_units_key),
                context.getString(R.string.pref_units_celsius_key))
                .equals(context.getString(R.string.pref_units_celsius_key));
    }
    ...
    public static String formatTemperature(Context context, double temperature) {
        ...
        if ( !isMetric(context) ) {
            ...
            result = context.getString(R.string.format_fahrenheit_temperature, temp);
        } else {
            temp = temperature;
            result = context.getString(R.string.format_celsius_temperature, temp);
        }
        return result;
    }
    ...
    static String formatDate(long dateInMillis) {
        ...
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(
                "dd-MMM-yyyy", new Locale(languageDevice));
    ...
    public static String getDayName(Context context, long dateInMillis) {
        ...
        if (julianDay == currentJulianDay) {
            ...
            SimpleDateFormat dayFormat = new SimpleDateFormat("EEEE", new Locale(languageDevice));
    ...
    public static String getFormattedMonthDay(Context context, long dateInMillis ) {
        ...
        SimpleDateFormat monthDayFormat = new SimpleDateFormat("dd MMMM", new Locale(languageDevice));
    ...
    public static String getFormattedWind(Context context, float windSpeed, float degrees) {
        ...
        if (degrees >= 337.5 || degrees < 22.5) {
            direction = context.getString(R.string.format_wind_direction_n);
        } else if (degrees >= 22.5 && degrees < 67.5) {
            direction = context.getString(R.string.format_wind_direction_n) +
                    context.getString(R.string.format_wind_direction_e);
        } else if (degrees >= 67.5 && degrees < 112.5) {
            direction = context.getString(R.string.format_wind_direction_e);
        } else if (degrees >= 112.5 && degrees < 157.5) {
            direction = context.getString(R.string.format_wind_direction_s) +
                    context.getString(R.string.format_wind_direction_e);
        } else if (degrees >= 157.5 && degrees < 202.5) {
            direction = context.getString(R.string.format_wind_direction_s);
        } else if (degrees >= 202.5 && degrees < 247.5) {
            direction = context.getString(R.string.format_wind_direction_s) +
                    context.getString(R.string.format_wind_direction_w);
        } else if (degrees >= 247.5 && degrees < 292.5) {
            direction = context.getString(R.string.format_wind_direction_w);
    ...
    public static void resetLocationStatus(Context context) {
        ...
        preferencesEditor.putInt(context.getString(R.string.pref_location_status_key), SunshineSyncAdapter.LOCATION_STATUS_UNKNOWN);
        preferencesEditor.apply();
    }

    // Obtener la traducción de una string sólo en español!!
//    public static String getStringResourceByName(Context context, String aString) {
//        String packageName = context.getPackageName();
//        int resId = context.getResources()
//                .getIdentifier(aString, "string", packageName);
//        if (resId != 0 &&  new Locale(languageDevice).toString().equals("es")) {
